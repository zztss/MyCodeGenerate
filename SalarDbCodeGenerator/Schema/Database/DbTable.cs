...
namespace SalarDbCodeGenerator.Schema.Database
{
    public class DbTable
    {
        ...
        private string _tableNameFirstUpper;
        #endregion
        ...
        public string TableNameFirstUpper
        {
            get
            {
                if (string.IsNullOrEmpty(_tableNameFirstUpper) &&
                    !string.IsNullOrEmpty(TableName))
                {
                    _tableNameFirstUpper = TableName.Substring(0, 1).ToUpper() + TableName.Substring(1);
                }

                return _tableNameFirstUpper;
            }
        }
